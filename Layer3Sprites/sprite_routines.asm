...
local_cursor_sprite2                equ local_cursor_sprite1+1       ; 06
    DISPLAY "TODO SORT OUT SPRITE GAP-just code tidy, spacing is needed for local chart"
local_hyper_sprite                  equ local_cursor_sprite2+5       ; 07
...
; bc = row hl = col D = sprite nbr , E= , pattern"
sprite_big_full_screen:       
...
; write out sprite pattern
                            ld      a,e                                 ; de = pattern and sprite nbr
                            or      %11000000                           ; 
...
;-----------------------------------------------------------------------
; bc =- row, hl = column
sprite_single_full_screen:  ld      a,d                                 ; a = sprite nbr, bug fix?
                            nextreg SPRITE_PORT_INDEX_REGISTER,a        ; set up sprite id
; write out X position bits 1 to 8
                            ld      a,l                                 ; a = column (c)
                            nextreg SPRITE_PORT_ATTR0_REGISTER,a        ; Set up lower x cc
...
sprite_galactic_hyper_cursor:ld     a,b
                            ...
                            ld      e,3
                            call    sprite_single_full_screen ; sprite_big:
                            ret
;-----------------------------------------------------------------------
