...
ApplyShipRollAndPitch:  ld      a,(rotZCounter)             ; get roll magnitudeShip Pitch counter
                        ld      b,a
                        and     SignOnly8Bit                
                        ld      c,a
...
.NoPitchDamping         ld      (univRAT2Val),a
                        ...
                        ld      (rotZCounter),a             ; rotZCounter = updated value
...
.NoRollDamping          ld      (univRAT2Val),a
                        ld      b,a
                        or      c                           ; bring sign back in
                        ld      (rotXCounter),a             ; rotZCounter = updated value
