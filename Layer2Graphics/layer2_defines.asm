...
LAYER2_SHADOW_SCREEN_MASK 	equ $00
    ENDIF
LAYER2_READ_ENABLE_MASK 	equ %00000100
LAYER2_WRITE_ENABLE_MASK 	equ %00000001
LAYER2_READ_WRITE_MASK      equ %00000101
LAYER2_SCREEN_SECTION_MASK 	equ $03
LAYER2_SCREEN_SECTION_SHIFT equ 6

LAYER2_DISABLE_MEM_WRITE    equ %11111110
LAYER2_DISABLE_MEM_READ     equ %11111011
LAYER2_DISABLE_MEM_ACCESS   equ %11111010

LAYER2_SCREEN_BANK1          equ 8
LAYER2_SCREEN_BANK2          equ 9
LAYER2_SCREEN_BANK3          equ 10
LAYER2_SCREEN_BANK4          equ 11     ; used by 320 and 640 mode
LAYER2_SCREEN_BANK5          equ 12     ; used by 320 and 640 mode
LAYER2_SHADOW_BANK1          equ 13
LAYER2_SHADOW_BANK2          equ 14
LAYER2_SHADOW_BANK3          equ 15
LAYER2_SHADOW_BANK4          equ 16     ; used by 320 and 640 mode
LAYER2_SHADOW_BANK5          equ 17     ; used by 320 and 640 mode
