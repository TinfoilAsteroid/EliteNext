...
;   DEFINE  MAINLOOP_DEBUGMISSILE 1
 ...
 ;   DEFINE  MAINLOOP_LAUNCHMISSILE
    ...
    DEFINE  MAINLOOP_SPACESTATION_RENDER 1
...
; bying and selling stock
                        ...
                        INCLUDE "./Universe/UniverseMacros/AIRuntimeDataMacro.asm"
                        ...
                        include "./Universe/UniverseMacros/FaceVisibility.asm"
                        include "./Universe/UniverseMacros/NormaliseTransMatMacro.asm"
                        include "./Universe/UniverseMacros/ScaleObjectDistanceMacro.asm"                        
                        INCLUDE "./Universe/UniverseMacros/XX12DefineMacro.asm"
                        INCLUDE "./Universe/UniverseMacros/XX15DefineMacro.asm"
                        INCLUDE "./Universe/UniverseMacros/XX16DefineMacro.asm"
                        INCLUDE "./Universe/UniverseMacros/XX18DefineMacro.asm"
                        INCLUDE "./Universe/UniverseMacros/XX25DefineMacro.asm"
                        include "./Universe/UniverseMacros/InitialiseOrientationMacro.asm"
                        include "./Universe/UniverseMacros/CopyRotmatToTransMatMacro.asm"
                        include "./Universe/UniverseMacros/ScaleNodeTo8BitMacro.asm"
                        include "./Universe/UniverseMacros/ScaleNormalMacro.asm"
                        INCLUDE "./Universe/UniverseMacros/BackfaceCullMacro.asm"
                        INCLUDE "./Universe/UniverseMacros/DrawLinesMacros.asm"
                        INCLUDE "./Universe/UniverseMacros/PrepLinesMacros.asm"
...
.StreamSpriteData:      MMUSelectSpriteBank
                        ...
                        MMUSelectKeyboard
                        call        init_keyboard
;-- SPRITE VERIFICATION AND WAIT FOR KEYPRESS -------------------------------------------------------------------------                        
...
;-- INITIALISE TIDY NORMALS COUNTER -----------------------------------------------------------------------------------
TidyInitialise:         ld          a,16
                        ld          (TidyCounter),a
InitJoyStick            xor			a
                        ld      (JSTX),a
...
IM2AttractMode:     IFDEF SKIPATTRACTMUSIC
...
CopyVertsToUniverse:
CopyVertsToUniverse1:     McopyVertsToUniverse    
    IFDEF SPACESTATIONUNIQUECODE
CopyNormsToSpaceStation:
CopyNormsToSpaceStation1: McopyNormsToSpaceStation
CopyVertsToSpaceStation:
CopyVertsToSpaceStation1: McopyVertsToSpaceStation
CopyEdgesToSpaceStation:
CopyEdgesToSpaceStation1: McopyEdgesToSpaceStation
CopyShipToSpaceStation:
CopyShipToSpaceStation1   MCopyShipToSpaceStation  BankShipModels1
CopyBodyToSpaceStation:
CopyBodyToSpaceStation1:  MCopyBodyToSpaceStation  CopyShipToSpaceStation1
    ENDIF
...
CopyVertsToUniverse2:    McopyVertsToUniverse     
    IFDEF SPACESTATIONUNIQUECODE
CopyNormsToSpaceStation2: McopyNormsToSpaceStation
CopyVertsToSpaceStation2: McopyVertsToSpaceStation
CopyEdgesToSpaceStation2: McopyEdgesToSpaceStation
CopyShipToSpaceStation2:  MCopyShipToSpaceStation  BankShipModels2
CopyBodyToSpaceStation2:  MCopyBodyToSpaceStation  CopyShipToSpaceStation2
    ENDIF
...
CopyVertsToUnivers3:    McopyVertsToUniverse    
    IFDEF SPACESTATIONUNIQUECODE
CopyNormsToSpaceStation3: McopyNormsToSpaceStation
CopyVertsToSpaceStation3: McopyVertsToSpaceStation
CopyEdgesToSpaceStation3: McopyEdgesToSpaceStation
CopyShipToSpaceStation3:  MCopyShipToSpaceStation  BankShipModels3
CopyBodyToSpaceStation3:  MCopyBodyToSpaceStation  CopyShipToSpaceStation3
    ENDIF
    DISPLAY "TODO: Move space stations into their own bank to simplify code macros"
...
; Bank 70  ------------------------------------------------------------------------------------------------------------------------
                    DISPLAY "FYI:Universe Bank 0 at slot ", BankUNIVDATA0
...
;;;;                IFDEF SPACESTATIONUNIQUECODE
;;;;                    INCLUDE "./Universe/SpaceStation/space_station_data.asm"
;;;;                ELSE
;;;;SPACESTATIONDataBlock:
;;;;UNIVDATABlock13     DB      $FF              ; we will use universe slot data and modify that to 24 bit calcs
;;;;                    DS $1FFF                 ; just allocate 8000 bytes for now
;;;;                ENDIF
...
; Bank 102  -----------------------------------------------------------------------------------------------------------------------
    ...
    ASSERT MainNonBankedCodeEnd < 0B000H, Program code leaks in to interrup vector table
