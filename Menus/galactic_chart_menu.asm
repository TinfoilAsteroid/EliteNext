...
;----------------------------------------------------------------------------------------------------------------------------------
GCM_DispDEIXtoIY:       ld (.GCMclcn32z),ix
                        ld (.GCMclcn32zIX),de
                        ld ix,.GCMclcn32t+36
                        ld b,9
                        ld c,0
...
.GCMclcn323:            djnz .GCMclcn321
                        ...
                        inc     IY
                        ret
.GCMclcn32t             dw 1,0,     10,0,     100,0,     1000,0,       10000,0
